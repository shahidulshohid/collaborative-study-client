...
const LoginPage = () => {
  ...
  return (
    <div>
      <Link to="/">
        <button className="ml-20 mt-2 text-blue-500 flex items-center gap-2">
          ...
          <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
            ...
            <div className="flex items-center justify-center -mt-5 gap-6">
              <button
                ...
                className="px-4 border border-blue-500 rounded-sm hover:bg-blue-500 hover:text-white font-semibold pb-1"
              >
                Google
              </button>
              <button
                onClick={handleGitHubLoginHandler}
                className="px-4 border border-blue-500 rounded-sm hover:bg-blue-500 hover:text-white font-semibold pb-1"
              >
                GitHub
              </button>
